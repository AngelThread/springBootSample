...
public class ClientControllerTest {
    ...
    public void clientRequestWithNullBody() throws Exception {
        ...
        mockMvc.perform(post("/clients/2/request")
            ...
            .andExpect(status().is(400))
            .andExpect(content()
                .string("{\"errors\":[\"Http Message Not Readable,not valid parsable body!\"],\"status\":400}"));
    ...
    private ClientRequestDto getClientRequestDtoSample(String s, String remoteIp, int customerID, String userID,
        int tagID) {
    ...
    public void wrongTimeStampValue() throws Exception {
        ...
        mockMvc.perform(post("/clients/2/request")
            ...
            .andExpect(content().string(
                "{\"errors\":[\"timestamp, must match \\\"^([1-9][5-9]\\\\d{8}\\\\d*|\\\\d{11,})$\\\"\"],\"status\":400}"));
